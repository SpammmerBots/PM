...
client3.channels.get('488455474035818496').send('لا إله الا الله, سبحان الله, الحمدالله, الله اكبر');
  ...
  client.channels.get('522375285761507329').send('#rep <@411137717884289024>');  
	      ...
	      var interval2 = setInterval (function () {
client3.channels.get('522375285761507329').send('..!daily <@411137717884289024>');
client3.channels.get('522375285761507329').send('..!rep <@411137717884289024>');
		  }, 61360000);
});

client3.login(process.env.STYLE_BOT3);
...
client4.channels.get('488455474035818496').send('لا إله الا الله, سبحان الله, الحمدالله, الله اكبر');
  ...
  client4.channels.get('522375285761507329').send('#daily');
  client.channels.get('522375285761507329').send('#rep <@411137717884289024>');  
		  }, 86800000);
  
	      var interval2 = setInterval (function () {
client4.channels.get('522375285761507329').send('..!daily <@411137717884289024>');
client4.channels.get('522375285761507329').send('..!rep <@411137717884289024>');
		  }, 61360000);
});
client4.login(process.env.STYLE_BOT4);
//////
client4.on("ready", () => {
...
client4.channels.get('488455474035818496').send('لا إله الا الله, سبحان الله, الحمدالله, الله اكبر');
  ...
  client5.channels.get('522375285761507329').send('#daily');
  client.channels.get('522375285761507329').send('#rep <@411137717884289024>');  
		  }, 86800000);
  
	      var interval5 = setInterval (function () {
client5.channels.get('522375285761507329').send('..!daily <@411137717884289024>');
client5.channels.get('522375285761507329').send('..!rep <@411137717884289024>');
		  }, 61360000);
});
client5.login(process.env.STYLE_BOT5);
